                            ...
                            foreach (IXLRow row in workSheet.RowsUsed().Skip(11))
                            {
                                ...
                                foreach (var prop in properties)
                                {
                                    if (prop.Name.ToString() == "Size")
                                    {
                                        ...
                                        size.XXXS = string.IsNullOrEmpty(row.Cell(colIndexSize + 8).Value.ToString()) ? 0 : Convert.ToInt32(row.Cell(colIndexSize + 8).Value);
                                    ...
                                    else if (prop.Name.ToString() == "Type")
                                    {
                                        ...
                                        var val = string.IsNullOrEmpty(row.Cell(colIndex).Value.ToString()) ? 1 : Convert.ToInt32(row.Cell(colIndex).Value);
